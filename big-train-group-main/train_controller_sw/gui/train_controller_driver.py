...
class DriverUI(QMainWindow):
    ...
    def update_from_train_controller(self):
        ...
        # Update train ID dropdown if train input is available
        if hasattr(self.train_controller, 'last_train_input') and self.train_controller.last_train_input:
            self.update_train_id_options(self.train_controller.last_train_input.available_train_ids)
    ...
    def get_selected_train_id(self):
        return self.selected_train_id
