...
Location: train_controller_sw/main_test.py
...
from controller.data_types import (TrainModelInput, DriverInput, EngineerInput, TrainModelOutput, 
                                   TrainControllerInit, BlockInfo)

# Import GUI components
from gui.train_controller_driver import DriverUI
from gui.train_controller_engineer import EngineerUI, EngineerWindow
...
class TrainControllerSystem(QMainWindow):
    ...
    def setup_driver_gui(self):
        """Initialize the Driver GUI"""
        self.driver_gui = DriverUI()
        ...
        print("Driver GUI initialized and displayed")
...
# =============================================================   
    ...
    def closeEvent(self, event):
        ...
        if hasattr(self, 'driver_gui'):
            self.driver_gui.close()
        if hasattr(self, 'engineer_gui'):
            self.engineer_gui.close()
        if hasattr(self, 'test_bench'):
