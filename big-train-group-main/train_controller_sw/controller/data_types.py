...
class TrainModelInput:
    ...
    Attributes:
        ...
        available_train_ids (list): List of available train IDs that can be selected.
    """
    ...
    available_train_ids: list           # List of available train IDs
...
class TrainModelOutput:
    ...
    Attributes:
        ...
        train_id (int): ID of the currently selected train.
